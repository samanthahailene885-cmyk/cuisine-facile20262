...
const PRODUCT_LIST = [
    { fullName: 'Sauce graine pure 350g', name: 'Sauce graine pure', image: 'img/Sauce graine pure 350g.png', price: 3500, format: 'Bocal verre 350g', category: 'Sauces et bases', fairPct: 60, coopId: 'vivriers-san-pedro', rating: '4,8', reviews: 36 },
    { fullName: 'Attiéké premium Agbodjama 500g', name: 'Attiéké premium Agbodjama', image: 'img/Attiéké premium Agbodjama 500g.png', price: 2500, format: 'Sachet 500g', category: 'Féculents', fairPct: 55, coopId: 'coop-attieke', rating: '4,8', reviews: 42 },
    ...
    { fullName: 'Soumbara en poudre 80g', name: 'Soumbara en poudre', image: 'img/Soumbara en poudre 80g.png', price: 1800, format: 'Sachet 80g', category: 'Épices', fairPct: 65, coopId: 'scoops-bene-wende', rating: '4,6', reviews: 22 },
    { fullName: 'Kankankan premium 100g', name: 'Kankankan premium', image: 'img/Kankankan premium 100g.png', price: 2200, format: 'Sachet 100g', category: 'Épices', fairPct: 65, coopId: 'scoopan-mba', rating: '4,7', reviews: 19 },
    { fullName: 'Sauce arachide prête 350g', name: 'Sauce arachide prête', image: 'img/Sauce arachide prête 350g.png', price: 3200, format: 'Bocal verre 350g', category: 'Sauces et bases', fairPct: 55, coopId: 'scoop-prokab', rating: '4,7', reviews: 31 },
    { fullName: 'Sauce pistache déshydratée 80g', name: 'Sauce pistache déshydratée', image: 'img/Sauce pistache déshydratée 80g.png', price: 1500, format: 'Bocal verre 80g', category: 'Sauces et bases', fairPct: 65, coopId: 'mamatchiva', rating: '4,7', reviews: 18 },
    { fullName: 'Mélange kedjenou 80g', name: 'Mélange kedjenou', image: 'img/Mélange kedjenou 80g.png', price: 1800, format: 'Bocal verre 80g', category: 'Épices', fairPct: 65, coopId: 'mamatchiva', rating: '4,7', reviews: 15 },
    { fullName: 'Mélange poisson braisé 80g', name: 'Mélange poisson braisé', image: 'img/Mélange poisson braisé 80g.png', price: 1800, format: 'Bocal verre 80g', category: 'Épices', fairPct: 65, coopId: 'pecheurs-sud', rating: '4,7', reviews: 14 },
    { fullName: 'Akpi moulu 60g', name: 'Akpi moulu', image: 'img/Akpi moulu 60g.png', price: 1500, format: 'Sachet 60g', category: 'Épices', fairPct: 60, coopId: 'scoops-caeg', rating: '4,7', reviews: 20 },
    ...
    { fullName: 'Beurre de karité alimentaire 250g', name: 'Beurre de karité alimentaire', image: 'img/Beurre de karité alimentaire 250g.png', price: 4500, format: 'Bocal verre 250g', category: 'Karité-arachide', fairPct: 55, coopId: 'gbinmin', rating: '4,8', reviews: 33 },
    { fullName: 'Miel de campagne 250g', name: 'Miel de campagne', image: 'img/Miel de campagne 250g.png', price: 3500, format: 'Bocal verre 250g', category: 'Karité-arachide', fairPct: 50, coopId: 'scoops-bene-wende', rating: '4,8', reviews: 27 },
    { fullName: 'Confiture bissap-gingembre 220g', name: 'Confiture bissap-gingembre', image: 'img/Confiture bissap-gingembre 220g.png', price: 3200, format: 'Bocal verre 220g', category: 'Karité-arachide', fairPct: 60, coopId: 'scoop-prokab', rating: '4,9', reviews: 29 },
    { fullName: 'Tablette chocolat single-origin 70g', name: 'Tablette chocolat single-origin', image: 'img/Tablette chocolat single-origin 70g.png', price: 3800, format: 'Boîte carton 70g', category: 'Karité-arachide', fairPct: 40, coopId: 'vivriers-san-pedro', rating: '4,9', reviews: 38 },
